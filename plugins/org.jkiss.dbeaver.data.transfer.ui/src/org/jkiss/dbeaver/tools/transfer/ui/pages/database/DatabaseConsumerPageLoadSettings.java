...
public class DatabaseConsumerPageLoadSettings extends ActiveWizardPage<DataTransferWizard> {
    ...
    public DatabaseConsumerPageLoadSettings() {
        super(DTUIMessages.data_transfer_wizard_page_load_settings_name);
        setTitle(DTUIMessages.data_transfer_wizard_page_load_settings_title);
        setDescription(DTUIMessages.data_transfer_wizard_page_load_settings_description);
    }
    ...
    public void createControl(Composite parent) {
...

        {
            Group loadSettings = UIUtils.createControlGroup(
            		composite, 
            		DTUIMessages.data_transfer_wizard_page_load_settings_name, 
            		1, 
            ...
            transferAutoGeneratedColumns = UIUtils.createCheckbox(
                loadSettings,
                DTUIMessages.data_transfer_wizard_settings_checkbox_transfer_generated_columns,
                DTUIMessages.data_transfer_wizard_settings_checkbox_transfer_generated_columns_values,
            ...
            truncateTargetTable = UIUtils.createCheckbox(
            		loadSettings, 
            		DTUIMessages.data_transfer_wizard_settings_checkbox_truncate_table, 
        ...
        {
            Group performanceSettings = UIUtils.createControlGroup(
            		composite, 
            		DTUIMessages.data_transfer_wizard_settings_group_performance, 
            		4, 
            		GridData.FILL_HORIZONTAL, 
            		0);
            ...
            final Button newConnectionCheckbox = UIUtils.createCheckbox(
                performanceSettings,
                DTUIMessages.data_transfer_wizard_settings_checkbox_new_connection,
                null,
            ...
            final Button useTransactionsCheck = UIUtils.createCheckbox(
            		performanceSettings, 
            		DTUIMessages.data_transfer_wizard_settings_checkbox_use_transactions, 
            		null, 
            ...
            final Spinner commitAfterEdit = UIUtils.createLabelSpinner(
            		performanceSettings, 
            		DTUIMessages.data_transfer_wizard_settings_label_commit_after_insert, 
...

        {
            Group generalSettings = UIUtils.createControlGroup(
            		composite, 
            		DTUIMessages.data_transfer_wizard_settings_group_general, 
            		4, 
            		GridData.FILL_HORIZONTAL, 
            		0);
            final Button showTableCheckbox = UIUtils.createCheckbox(
            		generalSettings, 
            		DTUIMessages.data_transfer_wizard_settings_checkbox_open_editor, 
            		null, 
            ...
            final Button showFinalMessageCheckbox = UIUtils.createCheckbox(
            		generalSettings, 
            		DTUIMessages.data_transfer_wizard_settings_checkbox_show_final_message, 
            		null, 
    ...
    private boolean confirmDataTruncate() {
        ...
        if (shell.isVisible() || getSettings().isTruncateBeforeLoad()) {
            ...
            if (!UIUtils.confirmAction(
            		shell, 
            		DTUIMessages.data_transfer_wizard_dialog_data_truncate_name, 
            		NLS.bind(DTUIMessages.data_transfer_wizard_dialog_data_truncate_message, tableNames)))
            {
                return false;
            }
        }
